...
% ── 12  Wireframes ──────────────────────────────────
\begin{frame}{Wireframes \& Sketches}
  \begin{columns}[T]
    \begin{column}{0.48\textwidth}
      \textbf{Main Experiment View}
      \begin{center}
        \fbox{\parbox{0.9\linewidth}{\centering\vspace{2cm}
          \textit{[Placeholder: Wireframe of 3D curve tracking viewport with crosshair]}
        \vspace{2cm}}}
      \end{center}
    \end{column}
    \begin{column}{0.48\textwidth}
      \textbf{Experiment Configuration Panel}
      \begin{center}
        \fbox{\parbox{0.9\linewidth}{\centering\vspace{2cm}
          \textit{[Placeholder: Wireframe of slider panel for 6 coefficients]}
        \vspace{2cm}}}
      \end{center}
    \end{column}
  \end{columns}
...
\begin{frame}{Interface Screens}
  \begin{columns}[T]
    \begin{column}{0.48\textwidth}
      \textbf{Curve Tracking Interface}
      \begin{center}
        \fbox{\parbox{0.9\linewidth}{\centering\vspace{2cm}
          \textit{[Placeholder: Screenshot of Unity3D curve tracking UI]}
        \vspace{2cm}}}
      \end{center}
    \end{column}
    \begin{column}{0.48\textwidth}
      \textbf{Parameter Control Panel}
      \begin{center}
        \fbox{\parbox{0.9\linewidth}{\centering\vspace{2cm}
          \textit{[Placeholder: Screenshot of slider controls and trial timer]}
        \vspace{2cm}}}
      \end{center}
    \end{column}
  \end{columns}
...
% ── 14  Storyboards ─────────────────────────────────
\begin{frame}{Storyboards \& Interaction Scenarios}
  \begin{columns}[T]
    \begin{column}{0.48\textwidth}
      \textbf{Scenario: Researcher Configures Experiment}
      \begin{center}
        \fbox{\parbox{0.9\linewidth}{\centering\vspace{1.5cm}
          \textit{[Placeholder: Storyboard panels showing researcher adjusting sliders, previewing curve, starting trial]}
        \vspace{1.5cm}}}
      \end{center}
    \end{column}
    \begin{column}{0.48\textwidth}
      \textbf{Scenario: Participant Tracks Curve}
      \begin{center}
        \fbox{\parbox{0.9\linewidth}{\centering\vspace{1.5cm}
          \textit{[Placeholder: Storyboard panels showing participant receiving instructions, tracking curve, trial completion]}
        \vspace{1.5cm}}}
      \end{center}
    \end{column}
  \end{columns}
