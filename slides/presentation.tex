...
\usepackage[style=authoryear-comp, backend=biber, maxcitenames=2]{biblatex}
...
\begin{frame}{Objectives \& Contributions}
  \textbf{Objectives}
  \begin{enumerate}
    \item Identify user needs for a 3D steering evaluation system
    \item Develop data-driven personas and scenarios
    \item Specify requirements balancing rigour, data quality \& usability
    \item Establish traceability between goals, needs \& system capabilities
  \end{enumerate}
  ...
  \begin{itemize}
    ...
    \item Personas \& scenarios grounded in human-centred design
    \item Structured HCML requirements specification
    \item Usability \& UX goals for high-quality data collection
  \end{itemize}
\end{frame}
